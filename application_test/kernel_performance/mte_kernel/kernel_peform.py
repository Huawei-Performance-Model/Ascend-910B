...
file_size={}
file_size[3]="../../../mte2_size3/all_norm_tasktime.csv"
file_size[4]="../../../mte2_size4/all_norm_tasktime.csv"
file_size[5]="../../../mte2_size5/all_norm_tasktime.csv"
model={}#这里就不讲究了，直接手动挑选负载GPU
model[3]=torch.load("../../../mte2_size3/size3_best.pth",map_location=device)
model[4]=torch.load("../../../mte2_size4/size4_best.pth",map_location=device)
model[5]=torch.load("../../../mte2_size5/size5_best.pth",map_location=device)
operator_cnt3=0
operator_cnt4=0
operator_cnt5=0
loss3=0
