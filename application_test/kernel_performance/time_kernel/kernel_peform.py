...
file_size={}
file_size[3]="../../../model_size_3/all_norm_tasktime.csv"
file_size[4]="../../../model_size_4/all_norm_tasktime.csv"
file_size[5]="../../../model_size_5/all_norm_tasktime.csv"
model={}#这里就不讲究了，直接手动挑选负载GPU
model[3]=torch.load("../../../model_size_3/size3_best.pth",map_location=device)
model[4]=torch.load("../../../model_size_4/size4_best.pth",map_location=device)
model[5]=torch.load("../../../model_size_5/size5_best.pth",map_location=device)
operator_cnt3=0
operator_cnt4=0
operator_cnt5=0
loss3=0
